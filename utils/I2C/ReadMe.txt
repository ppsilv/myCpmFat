...
"SCM_App_I2C_demo_v2.2.0.asm"

The Z80 executable code is in the files:
"SCM_App_I2C_demo_at_0C_v2.2.0_code8000.hex"
"SCM_App_I2C_demo_at_20_v2.2.0_code8000.hex"
Where 0C and 20 are the CPU's I/O port address of the I2C bus master, and
8000 is the address the program starts from.
...
The I/O port write and read results are indicated.
The output is configured as open collector with a weak pull up.
The I/O pins therefore function as quasi-bidirectional I/O.
...
SC138 Memory card  - not present
SC402 Memory module - present
SC403 Digital I/O Module (MCP23018) - present
SC404 Digital I/O Module (MCP23008) - present
SC405 Digital I/O Module (PCF8574)  - present
SC406 Temperature Sensor Module (TC74) - present
SC407 Switches and Lights Module (PCF8574) - present

*g8000
I2C demo/test v2.2.0 by Stephen C Cousins
I2C bus master I/O port address: 20 (all values in hex)
I2C bus master detected
I2C devices found at (7-bit hex addresses): 20 21 3A 3F 4D 50
SC138 Memory card (eg. 24LCxxx) at Address=57 (Write=AE Read=AF)
      Device not found
SC402 Memory module (eg. 24LCxxx) at Address=50 (Write=A0 Read=A1)
      Memory test passed
SC403 Digital I/O Module (MCP23018) at Address=20 (Write=40 Read=41)
      Output = FE, Input = FE
SC404 Digital I/O Module (MCP23008) at Address=21 (Write=42 Read=43)
      Output = FE, Input = FE
SC405 Digital I/O Module (PCF8574) at Address=3A (Write=74 Read=75)
      Output = 00, Input = 00
      Output = FF, Input = FF
SC406 Temperature Sensor Module (TC74) at Address=4D (Write=9A Read=9B)
      Temparature 'C (in hex) = 16 16 16
SC407 Switches and Lights Module (PCF8574) at Address=3F (Write=7E Read=7F)
      Output = 00, Input = 00
      Output = FF, Input = FF
